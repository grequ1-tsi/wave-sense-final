...
<div>
    ...
    <form wire:submit="login">
        ...
        <div>
            ...
            <x-text-input wire:model="form.email" id="email" class="block mt-1 w-full bg-emerald-dark" type="email" name="email" required autofocus autocomplete="username" />
        ...
        <div class="block mt-4">
            ...
            <x-primary-button class="ms-3 bg-highlight">
                {{ __('Log in') }}
            </x-primary-button>
        </div>
    </form>
